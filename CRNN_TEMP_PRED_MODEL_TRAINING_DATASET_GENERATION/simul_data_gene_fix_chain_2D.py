...
# Load the CSV file
# 2-D case
data = np.loadtxt("C:/Users/KOREA/Desktop/Naphtha_ML_SOURCE_CODE/CRNN_TEMP_PRED_MODEL_TRAINING_DATASET_GENERATION/sampling_case_wide_2D.csv", delimiter=",", skiprows=0) # [820 K - 1200 K]
#data = np.loadtxt("C:/Users/KOREA/Desktop/Naphtha_ML_SOURCE_CODE/CRNN_TEMP_PRED_MODEL_TRAINING_DATASET_CONTAINER/sampling_case_2D.csv", delimiter=",", skiprows=0) # [870 K - 1150 K]
...
def run_simulation(k):
    ...
    r_1 = ct.IdealGasReactor(contents=gas_1, energy='off')
    r_2 = ct.IdealGasReactor(contents=gas_2, energy='off')
    r_3 = ct.IdealGasReactor(contents=gas_3, energy='off')
    ...
    np.savetxt('C:/Users/KOREA/Desktop/Naphtha_ML_SOURCE_CODE/CRNN_TEMP_PRED_MODEL_TRAINING_DATASET_CONTAINER/fix_input_off_wide/LLNL_Eoff_'+str(k)+'.txt', nodedata_time_1)
    np.savetxt('C:/Users/KOREA/Desktop/Naphtha_ML_SOURCE_CODE/CRNN_TEMP_PRED_MODEL_TRAINING_DATASET_CONTAINER/fix_input_off_wide/JetSurf_Eoff_'+str(k)+'.txt', nodedata_time_2)
    np.savetxt('C:/Users/KOREA/Desktop/Naphtha_ML_SOURCE_CODE/CRNN_TEMP_PRED_MODEL_TRAINING_DATASET_CONTAINER/fix_input_off_wide/NUIG_Eoff_'+str(k)+'.txt', nodedata_time_3)

    # For normal temperature range [870 K - 1150 K] corresponding to sampling_case_2D
    #np.savetxt('C:/Users/KOREA/Desktop/Naphtha_ML_SOURCE_CODE/CRNN_TEMP_PRED_MODEL_TRAINING_DATASET_CONTAINER/fix_input_off/LLNL_Eoff_'+str(k)+'.txt', nodedata_time_1)
    #np.savetxt('C:/Users/KOREA/Desktop/Naphtha_ML_SOURCE_CODE/CRNN_TEMP_PRED_MODEL_TRAINING_DATASET_CONTAINER/fix_input_off/JetSurf_Eoff_'+str(k)+'.txt', nodedata_time_2)
    #np.savetxt('C:/Users/KOREA/Desktop/Naphtha_ML_SOURCE_CODE/CRNN_TEMP_PRED_MODEL_TRAINING_DATASET_CONTAINER/fix_input_off/NUIG_Eoff_'+str(k)+'.txt', nodedata_time_3)
